    ...
    return (
        <div className="profile--designer">
            ...
            <div className="profile--designer__links u-margin-bottom-medium">
                <Btn_4 text="Current" animation="2" routeTo="" selected={this.setActive} extendedClass={this.state.btn1} />
                <Btn_4 text="Past" animation="2" routeTo="" selected={this.setActive} extendedClass={this.state.btn2} />
                <Btn_4 text="About" animation="2" routeTo="" selected={this.setActive} extendedClass={this.state.btn3} />
            </div>
            <CardList designs={this.state.designs} colorModifier="black" />
        </div>
    )
}
}
